...
gnuplot -e "set key off; set xlabel 'w1'; set ylabel 'w2'; set zlabel 'F(x,y)'; splot 'fplotw1w2.dat' with linespoints pointtype 7, 'fplotw3w4.dat' with linespoints pointtype 5; pause -1"
