...
\begin{frame}
    ...
    \begin{equation}
        \hat{U} = \exp[-\frac{i}{\hbar}\left(A\int d\omega_1 \int d\omega_2 f(\omega_1,\omega_2) \creata_1(\omega_1) \creata_2(\omega_2) + h.c. \right) ]
    \end{equation}
%
    We can do re-write this Hamiltonian as a Schmidt-decomposition using a SVD.
    \begin{equation}
    -\frac{i}{\hbar}A f(\omega_1,\omega_2) = \sum_k r_k \psi_k(\omega_1) \phi_k(\omega_2)
    \end{equation}
