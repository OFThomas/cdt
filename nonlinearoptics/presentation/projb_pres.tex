...
\begin{frame}{The Joint Spectral Amplitude (JSA)} 
    \begin{figure}
        ...
        \begin{subfigure}{0.45\textwidth}
            \movie[height=0.9\textwidth,width=1.1\textwidth, loop, autostart]{}{jsasepgauss.mp4}
        \end{subfigure}
        ~
        \begin{subfigure}{0.45\textwidth}
...
\begin{frame}{Non-separable JSAs} 
    \begin{figure}
        \centering
        \begin{subfigure}{0.45\textwidth}
            \movie[height=0.9\textwidth,width=1.1\textwidth, loop, autostart]{}{jsanotsepsincgauss.mp4}
        \end{subfigure}
        ~
        \begin{subfigure}{0.45\textwidth}
